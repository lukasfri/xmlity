...
impl<'de> Deserializer<'de> for XmlText {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
    ...
    where
        V: Visitor<'de>,
    {
        visitor.visit_seq(&mut Some(self))
    }
}

impl<'de> Deserializer<'de> for XmlCData {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
...
impl<'de> de::XmlCData<'de> for XmlCData {
    ...
    fn into_string(self) -> Cow<'de, str> {
        Cow::Owned(String::from_utf8(self.0).unwrap())
    }
...
impl<'de> Deserializer<'de> for XmlChild {
    type Error = XmlValueDeserializerError;
...
impl<'de> Deserializer<'de> for XmlElement {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
...
impl<'de> crate::de::Deserializer<'de> for XmlAttribute {
    type Error = XmlValueDeserializerError;
...
impl<'de> Deserializer<'de> for &mut XmlSeqAccess<'_, XmlValue> {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
...
impl<'de> Deserializer<'de> for &mut XmlSeqAccess<'_, XmlChild> {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
...
impl<'de> Deserializer<'de> for XmlSeq<XmlValue> {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
...
impl<'de> Deserializer<'de> for XmlSeq<XmlChild> {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
...
impl<'de> Deserializer<'de> for XmlProcessingInstruction {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
...
impl<'de> Deserializer<'de> for XmlDecl {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
...
impl<'de> Deserializer<'de> for XmlComment {
    type Error = XmlValueDeserializerError;
    fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Self::Error>
    where
        V: Visitor<'de>,
...
impl<'de> Deserializer<'de> for XmlDoctype {
    type Error = XmlValueDeserializerError;
...
struct XmlElementAccess<'i> {
    element: XmlElement,
    attribute_index: usize,
    write_attribute_index_to: Option<&'i mut usize>,
}

impl Drop for XmlElementAccess<'_> {
    fn drop(&mut self) {
...
impl<'de> AttributesAccess<'de> for XmlElementAccess<'_> {
    type Error = XmlValueDeserializerError;
...
impl<'de> ElementAccess<'de> for XmlElementAccess<'_> {
    type ChildrenAccess = XmlSeqAccess<'static, XmlChild>;
    type NamespaceContext<'a>
        = ()
    where
        Self: 'a;
    ...
    fn children(mut self) -> Result<Self::ChildrenAccess, Self::Error> {
        let seq = mem::replace(&mut self.element.children, XmlSeq::new());
        Ok(XmlSeqAccess {
            seq,
            index: 0,
            write_index_to: None,
...
struct XmlSeqAccess<'i, T> {
    seq: XmlSeq<T>,
    index: usize,
    write_index_to: Option<&'i mut usize>,
}

impl<T> XmlSeqAccess<'_, T> {
    pub fn new(seq: XmlSeq<T>) -> Self {
        Self {
            seq,
            index: 0,
            write_index_to: None,
...
impl<T> Drop for XmlSeqAccess<'_, T> {
    fn drop(&mut self) {
...
impl<'de> de::SeqAccess<'de> for XmlSeqAccess<'_, XmlChild> {
    type Error = XmlValueDeserializerError;
    type SubAccess<'g>
        = XmlSeqAccess<'g, XmlChild>
    where
        Self: 'g;
    ...
    fn sub_access(&mut self) -> Result<Self::SubAccess<'_>, Self::Error> {
        let seq = mem::replace(&mut self.seq, XmlSeq::new());
...
impl<'de> de::SeqAccess<'de> for XmlSeqAccess<'_, XmlValue> {
    type Error = XmlValueDeserializerError;
    type SubAccess<'g>
        = XmlSeqAccess<'g, XmlValue>
    where
        Self: 'g;
    fn next_element<T>(&mut self) -> Result<Option<T>, Self::Error>
    where
...
impl<'de> de::XmlComment<'de> for XmlComment {
    type NamespaceContext<'a>
        = ()
    where
        Self: 'a;
...
impl<'de> de::XmlDoctype<'de> for XmlDoctype {
    type NamespaceContext<'a>
        = ()
    where
        Self: 'a;
...
impl<'de> de::XmlText<'de> for XmlText {
    type NamespaceContext<'a>
        = ()
    where
        Self: 'a;
...
impl<'de> de::SeqAccess<'de> for &mut Option<XmlText> {
    type Error = XmlValueDeserializerError;
